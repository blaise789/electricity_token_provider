...
import com.vehicle_tracking.dtos.response.SimpleErrorResponse; // Import your simple error DTO
import com.fasterxml.jackson.databind.ObjectMapper;
import jakarta.servlet.ServletException;
import jakarta.servlet.http.HttpServletRequest; // Correct import for HttpServletRequest
import jakarta.servlet.http.HttpServletResponse;
import lombok.extern.slf4j.Slf4j;
import org.springframework.http.MediaType; // For MediaType constant
