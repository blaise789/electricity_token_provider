package com.vehicle_tracking.vehicle_tracking.aspects;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.vehicle_tracking.vehicle_tracking.controllers..*) && execution(public * *(..))")
    ...
    @Before("execution(* com.vehicle_tracking.vehicle_tracking.services.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.vehicle_tracking.vehicle_tracking.services.*.*(..))", returning = "result")
