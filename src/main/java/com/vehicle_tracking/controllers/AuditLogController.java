package com.vehicle_tracking.controllers;// package com.vehicle_tracking.controllers;

import com.vehicle_tracking.dtos.response.PagedResponse; // You'd need to create this
